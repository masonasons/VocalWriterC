...
mkdir -p build
for f in speech tables music reverb macshim orthtophon parsephons track; do
    $CC $CFLAGS -c src/$f.c -o build/$f.o
done
$CC $CFLAGS -c test/layout.c -o build/layout.o
$CC $CFLAGS test/harness.c build/speech.o build/tables.o build/music.o build/reverb.o build/macshim.o build/orthtophon.o build/parsephons.o build/track.o build/layout.o -o build/harness -lm
